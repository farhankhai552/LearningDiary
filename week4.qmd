...
-   National Disaster Management Agency (NADMA)
    ...
    -    NADMA is also responsible for Early Communications System, which consists of:
        ...
        -   Malaysian Remote Sensing Agency
            ...
            ![](https://assets.nst.com.my/images/articles/dsijfijas_1640076515.jpg){width="339"}
...
**References** 'CHA-Malaysia.pdf' (no date). Available at: <https://jfit-for-science.asia/wp-content/uploads/2019/11/CHA-Malaysia.pdf> (Accessed: 19 March 2023).

Country: Malaysia (2023). Available at: <https://www.adrc.asia/management/MYS/mechanism_of_disaster_management_and_relief.html> (Accessed: 20 March 2023).

Malaysia - Vulnerability \| Climate Change Knowledge Portal (no date). Available at: <https://climateknowledgeportal.worldbank.org/country/malaysia/vulnerability> (Accessed: 23 March 2023)
